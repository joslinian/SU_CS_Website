...
Site [Trello Board](https://trello.com/b/eN8sN4kn/su-website-redesign), [Punch list](https://trello.com/b/vwKr6UbG/punch-list).

## Current Site Structure

### Department of Computer Science - Site Structure
  ...
  * *Department Information Events* 
      * Graduate Information Session
      	-(link this from event content type)
  
  > Page headings in **bold** are visible in the LHS menu. 
  > Non-bolded headings are not visible and are linked to on the parent or other page.
...
* Update Pictures and/or Graphics (yearly or as needed)
* review text content (yearly)

### Department of Computer Science (landing page)
* Update front page news article/recent department announcenment

### 1) Undergraduate Programs
* Update landing page spotlight (yearly or as needed)
* For all Sub-pages:
	-Update degree objectives and catalog links (yearly in Spring for following academic year)
* **Transfer Students**
	- Update spotlight (yearly or as needed)
	- Update quote (yearly or as needed)
* **5-Year Fast Track BS/MS**
	- check degree requirements (if changed)
	- link to 2-year schedule

### 2) Graduate Programs
* Update landing page spotlight (yearly or as needed)
* Update change marketing video on LHS (yearly or as needed)
...
* update marketing video (if new versions become available)
* **Computer Science Fundamentals**
	- update external links (as needed)
	- update marketing video (if new version becomes available)
	- timeline graphic (only if course/credit information changes)
	* **Programming Boot Camp**
		- Update syllabus links (if changed)
	* **FAQ**
		- Double check links and tags (yearly)
		- update any date/timeline references in the text (yearly)
		- add/remove any questions (as needed)
	* **Admission Requirements**
		- verify requirements and deadlines (yearly)
* **Software Engineering**
	- update quote (as needed)
	- update contact info and program catalog link (yearly)
	* **Admission Requirements**
		- verify requirements and deadlines (yearly)
